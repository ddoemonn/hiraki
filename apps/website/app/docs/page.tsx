...
export const metadata: Metadata = {
  title: 'Docs | Hiraki',
  description:
    'Documentation for Hiraki, the accessible React drawer primitives that are meant to be redesigned.',
}
...
export default function DocsOverviewPage() {
  return (
    <DocsPageFrame
      eyebrow="overview"
      title="The docs should prove the styling flexibility, not just say it."
